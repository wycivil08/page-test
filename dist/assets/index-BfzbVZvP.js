...
`)+`
`+p);const E=S+m+a,M=S+p+l,C=yl(i,i.VERTEX_SHADER,E),R=yl(i,i.FRAGMENT_SHADER,M);i.attachShader(g,C),i.attachShader(g,R),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function b(I){if(s.debug.checkShaderErrors){const V=i.getProgramInfoLog(g).trim(),k=i.getShaderInfoLog(C).trim(),X=i.getShaderInfoLog(R).trim();let j=!0,q=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if(j=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,g,C,R);else{const $=Tl(i,C,"vertex"),z=Tl(i,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
